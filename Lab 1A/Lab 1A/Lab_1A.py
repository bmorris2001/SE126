# Brandon Morris    Lab 1A     1/6/2020
...
while answer == "y" or answer == "Y":
    capacity = int(input("What is the max capacity of the room? :"))
    attending = int(input("How many people want to attend the meeting? :"))
    total_seats_avail = capacity - attending    # Seats available
    total_seats_avail_diff = total_seats_avail * -1 # The difference of people attending to cap
